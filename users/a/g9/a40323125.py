...
40323125_2 = Blueprint('40323125_2', __name__, url_prefix='/40323125_2', template_folder='templates')
...
@40323125_2.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@40323125_2.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@40323125_2.route('/circle1/<x>/<degree>', defaults={'y': 0})
@40323125_2.route('/circle1/<x>/<y>/<degree>')
#@40323125_2.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@40323125_2.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@40323125_2.route('/circle2/<x>/<degree>', defaults={'y': 0})
@40323125_2.route('/circle2/<x>/<y>/<degree>')
#@40323125_2.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@40323125_2.route('/twocircle/<x>/<y>')
@40323125_2.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@40323125_2.route('/eighteenthirty/<x>/<y>')
@40323125_2.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@40323125_2.route('/snap')
...
40323125_2 = s.group( r1,c1 ).attr({ 'id': '40323125_2' })
40323125_2.appendTo( g0 ).attr({ 'id': '40323125_2' })
40323125_2.animate({ 'transform' : 'r360,175,175' },4000)
